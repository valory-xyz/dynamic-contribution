// The following code is from flattening this file: DynamicContribution.sol
...
contract DynamicContribution is ERC721 {
    ...
    constructor() ERC721("DynamicContribution", "DC")
    {
        // to simplify fuzzing
    ...
    function echidna_track_tokenId() public view returns(bool){
        if(totalSupply > 0) {
            // exist
            // return tokenId > 0 && tokenId < (totalSupply + 1);
            return _ownerOf[totalSupply] != address(0);
        }
        return true;
    }
